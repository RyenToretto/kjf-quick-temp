...
|  命令 | 描述  | 备注 |
|---|---|---|
| `yarn start`  | 开启服务(server)和监听(watch) 一键启动 ✔️|
| `yarn server`  | 开启服务(server)  | 麻烦，可使用，不推荐 |
| `yarn watch`  | 开启监听(watch)  | 麻烦，可使用，不推荐 |
